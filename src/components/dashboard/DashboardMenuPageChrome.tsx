...
/**
 * Shell สำหรับหน้าเมนูหลัก (มิเตอร์ / บิล / ประวัติ / ผู้เช่า / เพิ่มผู้เช่า / ย้ายออก)
 * พื้นหลังเทาอ่อน (gray-50) + กรอบขาว + header เขียวโทนเดียวกับแท็บ Overview
 */
export function DashboardMenuPageChrome({
    ...
    return (
        <div className="min-h-screen bg-gray-50 sm:flex sm:items-center sm:justify-center sm:py-8 font-body text-slate-800 antialiased">
            <div className="w-full sm:max-w-lg bg-white min-h-screen sm:min-h-[850px] sm:rounded-[2.5rem] shadow-2xl overflow-hidden flex flex-col relative border-gray-100 sm:border">
